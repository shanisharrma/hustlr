import { IOrderMessage, IRatingTypes, IReviewMessageDetails, ISellerDocument } from '@shanisharrma/hustlr-shared';
  ...
  const updatedSeller: ISellerDocument = (await SellerModel.findOneAndUpdate(
    { _id: sellerId },
    {
      $set: {
        ...
        country: sellerData.description,
...
const updateSellerCancellerJobsProp = async (sellerId: string): Promise<void> => {
