import { OrderNotificationModel } from '@order/model/notification-model';
import { socketIOOrderObject } from '@order/server';
import { IOrderDocument, IOrderNotifcation } from '@shanisharrma/hustlr-shared';
...
const sendNotification = async (data: IOrderDocument, message: string, userToId: string): Promise<void> => {
